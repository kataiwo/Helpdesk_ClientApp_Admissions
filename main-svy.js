...
const surveyJson = {
  pages: [
      ...
      elements: [
          ...
          elements: [
            {
              ...
              title: "Name:",
              titleLocation: "left",
              placeholder: "Fullname / Nom et prénom",
              type: "text",
              isRequired: true,
              requiredErrorText: "Your name is required / Le nom est requis"
            }, 
            {
                name: "email",
                title: "Email:",
                ...
                type: "text",
                isRequired: true,
                requiredErrorText: "Email is required / l'e-mail est requis",
                validators: [
                  { "type": "email", "text": "Must be a valid email / Doit être un e-mail valide" }
                ]
            }, 
            // {
            //   name: "telNo",
        ...
        {        
          ...
          choices: ["Nigeria MILERT", "South-Africa MILERT", "Ghana MILERT", "Liberia MILERT", "Canada MILERT", "Malawi MILERT",
                    "Languages MILERT", "FRASED Abidjan", "FRASED Benin", "LEDEYO"],
    ...
    { 
      ...
      description: "Describe the challenge you are having. / Décrivez le défi que vous rencontrez.",
      elements: [
        {
          ...
          elements: [
            {
              ...
              title: "Subject / Sujet",
              // titleLocation: "left",
              placeholder: "Subject of your issue / sujet de votre problème",
              type: "text",
              isRequired: true,
              requiredErrorText: "Value cannot be empty / Ne peux pas être vide"
            }, 
            {
              name: "message",
              title: "Message",
              type: "comment",    
              isRequired: true,
              placeholder: "Enter a brief description of your issue here ... / Écrivez une brève description de votre problème ici...",
              maxLength: 600,
              allowResize: false
            }, 
          ]
        ...
        { 
          name: "file-upload",            
          type: "panel",
          title: "Upload file (if necessary) / Téléchargez le fichier (si nécessaire)",
  ...
  fitToContainer: true,
  completedHtml: "Thank you, please be checking your email for our response.<br />God bless you.<br />Merci, veuillez vérifier votre courrier électronique pour notre réponse.<br />Que Dieu vous bénisse.",
  completeText: "Send/Envoyer"
};
  ...
  createWidgetContent() {
    this.widgetContainer.innerHTML = `
      <header class="widget__header">
        ...
        <h3>Service d'assistance FRASED</h3>        
